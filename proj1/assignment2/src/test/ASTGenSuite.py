...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_short_vardecl(self):
        input = """delta: integer = 10;"""
        expect = """Program([
	VarDecl(delta, IntegerType, IntegerLit(10))
])"""
        self.assertTrue(TestAST.test(input, expect, 301))

    def test_full_vardecl(self):
        input = """a, b, c: integer = 10, 9, 8;"""
        expect = """Program([
	VarDecl(a, IntegerType, IntegerLit(10))
	VarDecl(b, IntegerType, IntegerLit(9))
	VarDecl(c, IntegerType, IntegerLit(8))
])"""
    ...
    def test_simple_program_with_UnExpr(self):
        ...
        b: auto = !true;"""
        expect = """Program([
	VarDecl(a, FloatType, UnExpr(-, IntegerLit(100)))
	VarDecl(b, AutoType, UnExpr(!, BooleanLit(True)))
])"""
        self.assertTrue(TestAST.test(input, expect, 303))
    def test_array_decl(self): 
        input = """a: array [9] of string;
        b: array[3] of float = {9.9, 9.8, 9.7}; """
        expect = """Program([
	VarDecl(a, ArrayType([9], StringType))
	VarDecl(b, ArrayType([3], FloatType), ArrayLit([FloatLit(9.9), FloatLit(9.8), FloatLit(9.7)]))
])"""
        self.assertTrue(TestAST.test(input, expect, 304))

    def test_arrayDeclStringAndFloat(self):
        input = """a: array [19, 19] of string = {"My", "BK", "ELearning"};
        b: array[9] of float = {1e2, 10.99e2}; """
        expect = """Program([
	VarDecl(a, ArrayType([19, 19], StringType), ArrayLit([StringLit(My), StringLit(BK), StringLit(ELearning)]))
	VarDecl(b, ArrayType([9], FloatType), ArrayLit([FloatLit(100.0), FloatLit(1099.0)]))
])"""
        self.assertTrue(TestAST.test(input, expect, 305))

    def testMore99(self):
        input = """case1, case2 : array [9,9] of float;"""
        expect = """Program([
	VarDecl(case1, ArrayType([9, 9], FloatType))
	VarDecl(case2, ArrayType([9, 9], FloatType))
])"""
        self.assertTrue(TestAST.test(input, expect, 306))

    def test_strDecl(self):
        input = """a, b : string = "Work","Hard";  """
        expect = """Program([
	VarDecl(a, StringType, StringLit(Work))
	VarDecl(b, StringType, StringLit(Hard))
])"""
        self.assertTrue(TestAST.test(input, expect, 307))

    def test_arrayDeclOp(self):
        input = """a: array [19, 19] of integer = {9_9, 9, 888, word};
        b: array[9] of boolean = {true, false, true}; """
        expect = """Program([
	VarDecl(a, ArrayType([19, 19], IntegerType), ArrayLit([IntegerLit(99), IntegerLit(9), IntegerLit(888), Id(word)]))
	VarDecl(b, ArrayType([9], BooleanType), ArrayLit([BooleanLit(True), BooleanLit(False), BooleanLit(True)]))
])"""
    ...
    def test_inherit_program_with_variable(self): 
        """Simple program"""
        input = """foo: function void (inherit a: integer, out b: float, inherit out c: auto) inherit bar {
        }"""
        expect = """Program([
	FuncDecl(foo, VoidType, [InheritParam(a, IntegerType), OutParam(b, FloatType), InheritOutParam(c, AutoType)], bar, BlockStmt([]))
])"""
        self.assertTrue(TestAST.test(input, expect, 312))
    def test_inherit_program_with_array(self): 
        """Simple program"""
        input = """foo: function array [5] of integer () inherit bar {
        }"""
        expect = """Program([
	FuncDecl(foo, ArrayType([5], IntegerType), [], bar, BlockStmt([]))
])"""
        self.assertTrue(TestAST.test(input, expect, 313))
    def test_inherit_program_with_arrayParam(self): 
        """Simple program"""
        input = """foo: function array [5] of integer (inherit a: array [9] of boolean) inherit bar {
        }"""
        expect = """Program([
	FuncDecl(foo, ArrayType([5], IntegerType), [InheritParam(a, ArrayType([9], BooleanType))], bar, BlockStmt([]))
])"""
    ...
    def test_inherit_program_with_arrayParam_and_stmt(self): 
        ...
        expect = """Program([
	FuncDecl(foo, ArrayType([5], IntegerType), [InheritParam(a, ArrayType([9], BooleanType))], bar, BlockStmt([VarDecl(x, IntegerType, UnExpr(-, IntegerLit(4))), ReturnStmt(Id(a))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 315))
    def test_program_with_for_stmt_1(self): 
        """Simple program"""
        input = """z: function string (inherit a: boolean) inherit bar {
            for (i = 1, i < 10, i + 1) {
                printInteger(i); 
                break; 
            }
        ...
        expect = """Program([
	FuncDecl(z, StringType, [InheritParam(a, BooleanType)], bar, BlockStmt([ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(<, Id(i), IntegerLit(10)), BinExpr(+, Id(i), IntegerLit(1)), BlockStmt([CallStmt(printInteger, Id(i)), BreakStmt()])), VarDecl(x, IntegerType, UnExpr(!, BooleanLit(True))), ReturnStmt(Id(a))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 316))
    def test_program_with_for_stmt_2(self): 
        """Simple program"""
        input = """z: function boolean (inherit a: boolean) inherit bar {
            for (i = 1, i < 10, i + 1) printInteger(i); 
            x:integer = !true;
            return a; 
        }"""
        expect = """Program([
	FuncDecl(z, BooleanType, [InheritParam(a, BooleanType)], bar, BlockStmt([ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(<, Id(i), IntegerLit(10)), BinExpr(+, Id(i), IntegerLit(1)), CallStmt(printInteger, Id(i))), VarDecl(x, IntegerType, UnExpr(!, BooleanLit(True))), ReturnStmt(Id(a))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 317))
    def test_ifstmt(self): 
        """Simple program"""
        input = """_varTmp: function integer (inherit i: integer) inherit bar {
            i:integer = 15 - 7 + 9;
            if (i%2==0) i = i + 1; 
            return i; 
        }"""
        expect = """Program([
	FuncDecl(_varTmp, IntegerType, [InheritParam(i, IntegerType)], bar, BlockStmt([VarDecl(i, IntegerType, BinExpr(+, BinExpr(-, IntegerLit(15), IntegerLit(7)), IntegerLit(9))), IfStmt(BinExpr(==, BinExpr(%, Id(i), IntegerLit(2)), IntegerLit(0)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1)))), ReturnStmt(Id(i))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 318))

    def test_whileLoop(self):
        """Simple program"""
        input = """_a: function integer (inherit out i: integer) inherit bar {
            i:integer = 15 - 7 + 9;
            while (i == 0) i = i + 1; 
            while (i > 9) {
                i = readInteger();
    ...
    def test_doWhileLoop1(self): 
        ...
        expect = """Program([
	FuncDecl(_a, IntegerType, [InheritOutParam(i, IntegerType)], bar, BlockStmt([VarDecl(a, ArrayType([5], IntegerType)), VarDecl(i, IntegerType, IntegerLit(0)), DoWhileStmt(BinExpr(<, Id(i), IntegerLit(5)), BlockStmt([AssignStmt(ArrayCell(a, [Id(i)]), IntegerLit(0)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1)))])), ReturnStmt(BinExpr(-, BinExpr(*, BinExpr(/, Id(i), IntegerLit(2)), UnExpr(-, IntegerLit(4))), IntegerLit(5)))]))
])"""
    ...
    def test_ifstmtWithblock(self):
        input = """_varTmp: function integer (out i: integer) inherit bar {
            i:integer = 15 - 7 + 9;
            if (i%2==0) {
                printInteger(i); 
            } 
        ...
        expect = """Program([
	FuncDecl(_varTmp, IntegerType, [OutParam(i, IntegerType)], bar, BlockStmt([VarDecl(i, IntegerType, BinExpr(+, BinExpr(-, IntegerLit(15), IntegerLit(7)), IntegerLit(9))), IfStmt(BinExpr(==, BinExpr(%, Id(i), IntegerLit(2)), IntegerLit(0)), BlockStmt([CallStmt(printInteger, Id(i))])), ReturnStmt(Id(i))]))
])"""
    ...
    def test_doWhileLoop2(self): 
        input = """_a: function integer (inherit out i: auto) inherit bar {
            a: array [5] of integer;
            i: integer = 0; 
            do {
                a[i] = 0; 
        ...
        expect = """Program([
	FuncDecl(_a, IntegerType, [InheritOutParam(i, AutoType)], bar, BlockStmt([VarDecl(a, ArrayType([5], IntegerType)), VarDecl(i, IntegerType, IntegerLit(0)), DoWhileStmt(BinExpr(<, Id(i), IntegerLit(5)), BlockStmt([AssignStmt(ArrayCell(a, [Id(i)]), IntegerLit(0)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1)))])), AssignStmt(ArrayCell(a, [IntegerLit(2)]), BinExpr(-, BinExpr(+, ArrayCell(a, [IntegerLit(1)]), BinExpr(*, IntegerLit(19), IntegerLit(4))), BinExpr(/, IntegerLit(2), IntegerLit(1)))), ReturnStmt(ArrayCell(a, [IntegerLit(2)]))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 328))
        
    def test_doWhileLoop3(self): 
        input = """_a: function integer (inherit out i: auto) inherit bar {
            a: array [5] of integer;
            i: integer = 0; 
            do {
        ...
        expect = """Program([
	FuncDecl(_a, IntegerType, [InheritOutParam(i, AutoType)], bar, BlockStmt([VarDecl(a, ArrayType([5], IntegerType)), VarDecl(i, IntegerType, IntegerLit(0)), DoWhileStmt(BinExpr(<, Id(i), IntegerLit(5)), BlockStmt([AssignStmt(ArrayCell(a, [Id(i)]), IntegerLit(0)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1)))])), AssignStmt(ArrayCell(a, [IntegerLit(2)]), BinExpr(+, ArrayCell(a, [IntegerLit(1)]), BinExpr(*, IntegerLit(19), IntegerLit(4)))), ReturnStmt(ArrayCell(a, [IntegerLit(2)]))]))
])"""
    ...
    def test_callExpr_2param(self): 
        """Simple program"""
        input = """
        fntmp: function integer (a: integer, b: integer) {
            if (b == 0) return a; 
            return fntmp(b, a % b); 
        }
        ...
        expect = """Program([
	FuncDecl(fntmp, IntegerType, [Param(a, IntegerType), Param(b, IntegerType)], None, BlockStmt([IfStmt(BinExpr(==, Id(b), IntegerLit(0)), ReturnStmt(Id(a))), ReturnStmt(FuncCall(fntmp, [Id(b), BinExpr(%, Id(a), Id(b))]))]))
	FuncDecl(main, VoidType, [InheritOutParam(i, IntegerType)], None, BlockStmt([VarDecl(a, IntegerType, UnExpr(-, UnExpr(-, IntegerLit(15)))), VarDecl(b, IntegerType, IntegerLit(60)), ReturnStmt(FuncCall(fntmp, [Id(a), Id(b)]))]))
])"""
    ...
    def test_SRO(self):
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, StringType, BinExpr(::, StringLit(PPL), StringLit(223))), CallStmt(printString, Id(a))]))
])"""
    ...
    def test_doWhileLoop_continue(self): 
        ...
        expect = """Program([
	FuncDecl(_a, IntegerType, [InheritOutParam(i, IntegerType)], bar, BlockStmt([VarDecl(i, IntegerType, BinExpr(+, BinExpr(-, IntegerLit(99), IntegerLit(9)), IntegerLit(8))), DoWhileStmt(BinExpr(<, Id(i), IntegerLit(100)), BlockStmt([AssignStmt(Id(i), BinExpr(*, Id(i), IntegerLit(2))), IfStmt(BinExpr(<, Id(i), IntegerLit(64)), ContinueStmt(), BreakStmt())])), ReturnStmt(Id(i))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 337))

    def program_LoopFor(self):
        input =	"""x: integer = 76;
    ...
    def test_CallExpr(self):
        ...
        """
        expect = """Program([
	FuncDecl(foo, IntegerType, [], bar, BlockStmt([ReturnStmt(IntegerLit(1))]))
	VarDecl(x, IntegerType, FuncCall(foo, []))
])"""
        self.assertTrue(TestAST.test(input, expect, 339))

    def test_SubUnExpr(self):
        input = """
                foo: function integer () inherit bar {
                return 1; 
        }
        ...
        expect = """Program([
	FuncDecl(foo, IntegerType, [], bar, BlockStmt([ReturnStmt(IntegerLit(1))]))
	VarDecl(x, IntegerType, UnExpr(-, FuncCall(foo, [])))
])"""
        self.assertTrue(TestAST.test(input, expect, 340))

    def test_NotUnExpr(self):
        input = """
                foo: function integer () inherit bar {
                return 9; 
        }
        ...
        """
        expect = """Program([
	FuncDecl(foo, IntegerType, [], bar, BlockStmt([ReturnStmt(IntegerLit(9))]))
	VarDecl(x, IntegerType, UnExpr(!, FuncCall(foo, [])))
])"""
    ...
    def test_SubExpr_Global(self): 
        ...
        """
        expect = """Program([
	FuncDecl(foo, IntegerType, [], bar, BlockStmt([ReturnStmt(IntegerLit(999))]))
	VarDecl(x, IntegerType, BinExpr(*, BinExpr(+, IntegerLit(77), IntegerLit(9)), IntegerLit(8)))
])"""
        self.assertTrue(TestAST.test(input, expect, 343))

    def test_IndexOpGlobal(self):
        input = """
    ...
    def test_IndexOpGlobal(self):
        ...
        """
        expect = """Program([
	VarDecl(a, ArrayType([4], IntegerType), ArrayLit([IntegerLit(1), IntegerLit(2), IntegerLit(3), IntegerLit(4)]))
	VarDecl(b, IntegerType, BinExpr(*, ArrayCell(a, [IntegerLit(1)]), IntegerLit(4)))
])"""
    ...
    def test_SubUnexprExpr(self):
        ...
        expect = """Program([
	FuncDecl(foo, IntegerType, [], bar, BlockStmt([ReturnStmt(IntegerLit(1))]))
	VarDecl(x, IntegerType, BinExpr(+, BinExpr(*, IntegerLit(55), IntegerLit(7)), UnExpr(-, FuncCall(foo, []))))
])"""
    ...
    def test_if_do_nothing(self): 
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([IfStmt(BinExpr(>, IntegerLit(1), IntegerLit(9)), BlockStmt([]))]))
])"""
    ...
    def test_ifelse3(self):
        ...
        expect = """Program([
	VarDecl(x, IntegerType, IntegerLit(76))
    ...
    def test_ifElse99(self):
        ...
        expect = """Program([
	VarDecl(x, IntegerType, IntegerLit(76))
	FuncDecl(fact, IntegerType, [Param(n, IntegerType)], None, BlockStmt([AssignStmt(Id(n), IntegerLit(0)), WhileStmt(BinExpr(<, Id(n), IntegerLit(99)), BlockStmt([CallStmt(printString, StringLit(Tran Ngoc Bao Duy)), AssignStmt(Id(n), BinExpr(+, Id(n), IntegerLit(1))), IfStmt(BinExpr(==, Id(n), IntegerLit(98)), BreakStmt())])), WhileStmt(BinExpr(>, Id(n), IntegerLit(67)), AssignStmt(Id(n), BinExpr(-, Id(n), IntegerLit(1)))), ReturnStmt(Id(n))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 354))
        
    def test_ifElse98(self):
        input =	"""x: integer = 76;
        fact: function integer (n: integer) {
            n = 0; 
            while (n < 99){
        ...
        expect = """Program([
	VarDecl(x, IntegerType, IntegerLit(76))
	FuncDecl(fact, IntegerType, [Param(n, IntegerType)], None, BlockStmt([AssignStmt(Id(n), IntegerLit(0)), WhileStmt(BinExpr(<, Id(n), IntegerLit(99)), BlockStmt([CallStmt(printString, StringLit(Tran Ngoc Bao Duy)), AssignStmt(Id(n), BinExpr(+, Id(n), IntegerLit(1))), IfStmt(BinExpr(==, Id(n), IntegerLit(98)), BreakStmt(), ContinueStmt())])), WhileStmt(BinExpr(>, Id(n), IntegerLit(67)), AssignStmt(Id(n), BinExpr(-, Id(n), IntegerLit(1)))), ReturnStmt(Id(n))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 355))
    ...
    def test_ifelse5(self): 
        input =	"""
        iOT : function string (inherit SE: integer, inherit out foo: string, out FS: string) inherit dADN{
                result: string = "CE"; 
                readInteger();
                printString(foo);
                result = result + "CS"; 
        ...
        expect = """Program([
	FuncDecl(iOT, StringType, [InheritParam(SE, IntegerType), InheritOutParam(foo, StringType), OutParam(FS, StringType)], dADN, BlockStmt([VarDecl(result, StringType, StringLit(CE)), CallStmt(readInteger, ), CallStmt(printString, Id(foo)), AssignStmt(Id(result), BinExpr(+, Id(result), StringLit(CS))), ReturnStmt(Id(result))]))
    ...
    def test_scope_expr(self): 
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(s, StringType, BinExpr(::, StringLit(PPL), StringLit(223)))]))
])"""
    ...
    def test_calcWithStmt(self):
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, IntegerType, IntegerLit(0)), VarDecl(b, IntegerType, IntegerLit(1)), IfStmt(BinExpr(<, Id(a), IntegerLit(2023)), AssignStmt(Id(a), BinExpr(+, BinExpr(-, BinExpr(*, IntegerLit(100), IntegerLit(7)), IntegerLit(4)), BinExpr(%, BinExpr(/, BinExpr(*, IntegerLit(98), IntegerLit(120)), IntegerLit(64)), IntegerLit(34)))), AssignStmt(Id(b), BinExpr(||, BinExpr(==, BinExpr(+, IntegerLit(1), IntegerLit(2)), IntegerLit(3)), BinExpr(>=, BinExpr(+, IntegerLit(3), IntegerLit(4)), IntegerLit(8))))), CallStmt(printInteger, Id(a)), CallStmt(printInteger, Id(b))]))
])"""
# b = 1 + 2 == 3 || 3 + 4 >= 8;
    ...
    def test_UnaryExpr2(self):
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([AssignStmt(Id(ppl), IntegerLit(99)), AssignStmt(Id(ppl), BinExpr(+, IntegerLit(99), UnExpr(-, IntegerLit(1)))), CallStmt(printString, BinExpr(::, StringLit(PPL), StringLit(223)))]))
])"""
    ...
    def test_calcMixedExprIfStmt3(self):
        input = """main: function void () {
            a,b: integer = 0,1; 
            if (a < 2023) a = 100 * 7 + -4 + 98/ 64 % 34;
            else b = !(1 + 2 == 3) || 3 + 4 >= 8;
            printInteger(a); 
            printInteger(b); 
        }"""
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, IntegerType, IntegerLit(0)), VarDecl(b, IntegerType, IntegerLit(1)), IfStmt(BinExpr(<, Id(a), IntegerLit(2023)), AssignStmt(Id(a), BinExpr(+, BinExpr(+, BinExpr(*, IntegerLit(100), IntegerLit(7)), UnExpr(-, IntegerLit(4))), BinExpr(%, BinExpr(/, IntegerLit(98), IntegerLit(64)), IntegerLit(34)))), AssignStmt(Id(b), BinExpr(>=, BinExpr(||, UnExpr(!, BinExpr(==, BinExpr(+, IntegerLit(1), IntegerLit(2)), IntegerLit(3))), BinExpr(+, IntegerLit(3), IntegerLit(4))), IntegerLit(8)))), CallStmt(printInteger, Id(a)), CallStmt(printInteger, Id(b))]))
])"""
    ...
    def test_compare_hard2(self): 
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, IntegerType, IntegerLit(9998)), VarDecl(b, IntegerType, IntegerLit(9999)), VarDecl(c, BooleanType, BinExpr(>=, Id(a), BinExpr(+, Id(b), BinExpr(/, IntegerLit(2), BinExpr(%, IntegerLit(4), IntegerLit(4))))))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 376))
    ...
    def test_compare_easy3(self): 
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, IntegerType, IntegerLit(9998)), VarDecl(b, ArrayType([10], IntegerType)), IfStmt(BinExpr(>, ArrayCell(b, [IntegerLit(0)]), Id(a)), AssignStmt(Id(a), ArrayCell(b, [IntegerLit(0)])), AssignStmt(ArrayCell(b, [IntegerLit(0)]), Id(a)))]))
])"""
    ...
    def test_compare_hard1(self):
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, IntegerType, IntegerLit(9998)), VarDecl(b, IntegerType, IntegerLit(9999)), VarDecl(c, BooleanType, BinExpr(>=, Id(a), Id(b)))]))
])"""
        self.assertTrue(TestAST.test(input, expect, 375))
    ...
    def test_ArrayStmt2ParamInIfStmt1(self):
        input = '''
    ...
    def test_strAdv(self):
        input = """ lolStr: string = "Test test2"; """
        expect = """Program([
	VarDecl(lolStr, StringType, StringLit(Test test2))
])"""
    ...
    def test_arrAssign2(self): 
        input = """
        a, b: array [4] of integer = {c + d, e * f} , {1, 2, 3, 4};
        """
        expect = """Program([
	VarDecl(a, ArrayType([4], IntegerType), ArrayLit([BinExpr(+, Id(c), Id(d)), BinExpr(*, Id(e), Id(f))]))
	VarDecl(b, ArrayType([4], IntegerType), ArrayLit([IntegerLit(1), IntegerLit(2), IntegerLit(3), IntegerLit(4)]))
])"""
        self.assertTrue(TestAST.test(input, expect, 391))

    def test_arrAssign3(self): 
        input = """
        a, b: array [4] of integer = n, m;
        """
        expect = """Program([
	VarDecl(a, ArrayType([4], IntegerType), Id(n))
	VarDecl(b, ArrayType([4], IntegerType), Id(m))
])"""
	...
	FuncDecl(inc, VoidType, [OutParam(n, IntegerType), Param(delta, ArrayType([1], IntegerType))], None, BlockStmt([VarDecl(i, IntegerType), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(<, Id(i), FuncCall(fact, [IntegerLit(10)])), BinExpr(+, Id(i), IntegerLit(1)), BlockStmt([WhileStmt(BinExpr(>, FuncCall(fact, [IntegerLit(10)]), IntegerLit(99)), BreakStmt()), ContinueStmt()]))]))
])"""
